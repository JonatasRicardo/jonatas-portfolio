...
name: rulesync
description: >-
  Generates and syncs AI rule configuration files (.cursorrules, AGENTS.md,
...
Rulesync generates and synchronizes AI rule configuration files across 20+ coding tools (Codex, Cursor, Copilot, Windsurf, Cline, Gemini CLI, and more) from a single set of unified rule files in `.rulesync/`.
...
rulesync import --targets Codex    # From AGENTS.md
...
3. **Generate** - `rulesync generate` produces tool-specific files (AGENTS.md, .cursorrules, .github/copilot-instructions.md, etc.)
